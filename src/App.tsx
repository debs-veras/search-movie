        ...
        <div className="container mx-auto flex flex-col md:flex-row gap-6 items-center">
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              <option value="movie">
                <Clapperboard className="inline mr-2" size={14} />
                Filmes
              </option>
              <option value="series">
                <Tv className="inline mr-2" size={14} />
                Séries
              </option>
              <option value="anime">
            ...
            <div className="relative rounded-xl overflow-hidden border border-gray-900 bg-[linear-gradient(135deg,#0f0f0f_0%,#1a1a1a_100%)] mb-12">
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-10">
                <div className="animate-film-roll">
                  <Film size={300} className="text-gray-400" />
                </div>
              </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  {
                    icon: <AlignCenterVertical size={24} />,
                    title: "Lançamentos",
                    count: "87",
                    color: "green",
                  },
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              <Popcorn size={24} className="text-red-600" />
